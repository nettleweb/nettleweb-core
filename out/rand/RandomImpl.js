...
export class sfc32 extends AbstractRandom {
    #a;
    #b;
    #c;
    #d;
...
export class splitmix32 extends AbstractRandom {
    #x;
    constructor(seed) {
        super(seed ||= seedgen());
        this.#x = seed;
...
export class mulberry32 extends AbstractRandom {
    #x;
    constructor(seed) {
        super(seed ||= seedgen());
        this.#x = seed;
...
export class xoshiro128 extends AbstractRandom {
    #a;
    #b;
    #c;
    #d;
